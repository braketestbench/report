\subsection{System Controlling}\label{ssec:mcu-review}
	...
	\begin{figure}[htbp]
		\centering
			\includegraphics[scale=0.7]{figuras/fig-atmega32u4-architecture}
	...
	\begin{figure}[htbp]
		\centering
			\includegraphics[scale=0.7]{figuras/fig-dutyCycle}
