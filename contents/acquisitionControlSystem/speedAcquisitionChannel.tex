	...
	\subsection{CKP Signal Conditioning}\label{ssec:ckp-signal-conditioning-circuit}
		...
		\subsubsection{LM2907 Designed Circuit}\label{sssec:lm2907-designed-circuit}
			...
			\begin{itemize}
				...
				\item\textit{\textbf{R78:}} This resistor is recommended by \cite{lm2907-datasheet} in order to use the voltage reference functionality.\item{itm:reference-resistor}
			\end{itemize}
