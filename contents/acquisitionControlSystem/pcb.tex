\section{Circuit Fabrication and Assembly}\label{sec:printed-circuit-board}
	...
	\subsection{PCB Design}\label{ssec:pcb-design}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=.8\textwidth]{figuras/fig-pcb-design-top.png}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=.8\textwidth]{figuras/fig-pcb-design-bottom.png}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=.8\textwidth]{figuras/fig-pcb-print-diagonal.png}
			\caption{PCB 3D View}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=.8\textwidth]{figuras/fig-pcb-print-top.png}
		...
		\begin{figure}[htbp]
			\centering
			\includegraphics[width=.8\textwidth]{figuras/fig-pcb-print-bottom}
